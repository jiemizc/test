...
/**
 * Default Pregel-style CC computation.
 */
public class ConnectedComponent implements Tool {
	/** Class logger */
	private static final Logger LOG = Logger
			.getLogger(ConnectedComponent.class);
	...
	public final int run(final String[] args) throws Exception {
		...
		job.getConfiguration().setVertexClass(ConnectedComponentVertex.class);
		job.getConfiguration().setBoolean("giraph.isStaticGraph", true);
		job.getConfiguration().setVertexInputFormatClass(
				IntIntNullTextInputFormat.class);
	...
	public static void main(final String[] args) throws Exception {
		System.exit(ToolRunner.run(new ConnectedComponent(), args));
	}
}
